<div>
    <div class="col-md-4">
        <div class="row">
            @livewire('form.text', ['name' => 'title', 'label' => 'Title', 'required' => 'required', 'value' =>
            $notification ? $notification->title : ''])
        </div>
    </div>
    <div class="col-md-4">
        <div class="row">
            @livewire('form.select', ['name' => 'trigger', 'label' => 'Trigger', 'options' => $triggers, 'listener' =>
            'changeTrigger', 'selected' => $notification ? $notification->trigger : ''], key('trigger'))
        </div>
    </div>
    <div class="col-md-4">
        <div class="row">
            @livewire('form.select', ['name' => 'category_id', 'nullable' => true, 'label' => 'Category', 'options' =>
            $notificationCategories, 'selected' => $notification ? $notification->category_id : '', 'option_value' =>
            'key'], key('notification-category'))
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    $daysOfMonth, 'selected' => $notification && $notification->additional &&
                    isset($notification->additional['day']) ? $notification->additional['day'] : '', 'option_value' =>
                    'key'])
                </div>
            </div>
            @endif
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    $weekDays, 'selected' => $notification && $notification->additional &&
                    isset($notification->additional['week_day']) ? $notification->additional['week_day'] : '',
                    'option_value' => 'key'])
                </div>
            </div>
            @endif
            <div class="col-md-6">
                <div class="row">
                    @livewire('form.time', ['name' => 'additional[time]', 'label' => 'Time', 'required' => 'required',
                    'value' => $notification && $notification->additional && isset($notification->additional['time']) ?
                    $notification->additional['time'] : 0])
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="row">
            @livewire('form.date-time', ['name' => 'additional[time]', 'label' => 'Time', 'required' => 'required',
            'value' => $notification && $notification->additional && isset($notification->additional['time']) ?
            $notification->additional['time'] : 0])
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="row">
                    ...
                    'required', 'value' => $notification && $notification->additional &&
                    isset($notification->additional['delay_d']) ? $notification->additional['delay_d'] : 0])
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    'required', 'value' => $notification && $notification->additional &&
                    isset($notification->additional['delay_m']) ? $notification->additional['delay_m'] : 0])
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    'required', 'value' => $notification && $notification->additional &&
                    isset($notification->additional['delay_h']) ? $notification->additional['delay_h'] : 0])
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="row">
            ...
            'listener' => 'changeType',
            'selected' => $notification ? (is_array($notification->notification_type) ? $notification->notification_type
    ...
    <div class="col-md-6">
        <div class="row">
            <div @if (!in_array('email', $type) && !in_array('push', $type)) style="display:none;" @endif>
                @livewire('form.text', [
                'name' => 'subject',
                'label' => 'Subject',
                'required' => 'required',
                'value' => $notification ? $notification->subject : ''
                ], key('notification-subject-field'))
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="row">
            <div @if (!in_array('email', $type)) style="display:none;" @endif>
                @livewire('form.select', [
                'name' => 'email_template',
                'label' => 'Email Template',
                'options' => $emailTemplates,
                'selected' => $notification ? $notification->email_template : ''
    ...
    <div class="col-md-12">
        <div class="row">
            @livewire('form.text-area', ['name' => 'content', 'label' => 'Message', 'value' => $notification ?
            $notification->content : ''])
        </div>
    </div>
    <div class="col-md-12">
        <div class="row">
            @livewire('form.checkbox', ['name' => 'active', 'label' => 'Active', 'value' => 1, 'checked' =>
